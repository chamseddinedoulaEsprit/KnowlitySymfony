...
export default class extends Controller {
    ...
    steps = [
        { id: 'intro', message: 'Bienvenue dans le catalogue des cours ! Cliquez sur "Suivant" pour commencer.', target: null },
        { id: 'search-input', message: 'Utilisez ce champ pour rechercher un cours par titre.', target: '[data-guide-step="search-input"]' },
        { id: 'filter-select', message: 'Filtrez les cours par matière avec cette liste.', target: '[data-guide-step="filter-select"]' },
        { id: 'sort-buttons', message: 'Triez les cours en cliquant sur ces boutons.', target: '[data-guide-step="sort-buttons"]' },
        { id: 'course-grid', message: 'Cliquez sur un cours ici pour voir ses détails.', target: '[data-guide-step="course-grid"]' },
        { id: 'end', message: 'Vous êtes prêt à explorer ! Fermez ce guide pour commencer.', target: null }
    ];
